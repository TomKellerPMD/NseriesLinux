...
//PMDCFunc PMDDeviceOpenPeriphSerial(PMDPeriphHandle* hPeriph, PMDDeviceHandle *hDevice, PMDparam portnum, PMDparam baud, PMDSerialParity parity, PMDSerialStopBits stopbits)
PMDCFunc PMDDeviceOpenPeriphSerial(PMDPeriphHandle* hPeriph, PMDDeviceHandle *hDevice, char * localport, PMDparam baud, PMDSerialParity parity, PMDSerialStopBits stopbits)
{
    PMDZeroMemory(hPeriph, sizeof(PMDPeriphHandle));
    if (hDevice == NULL)
        return PMDPCOM_Open(hPeriph, localport, baud, parity, stopbits);
   // else
