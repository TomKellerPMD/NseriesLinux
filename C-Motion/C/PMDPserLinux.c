...
#define INVALID_HANDLE_VALUE -100
//#define LOCK_UN 0
...
PMDresult PMDPCOM_Open(PMDPeriphHandle* hPeriph, char *szPort, PMDparam baud, PMDSerialParity parity, PMDSerialStopBits stopbits)
{
    //_TCHAR szPort[12];
