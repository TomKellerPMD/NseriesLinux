...
struct timespec ConvertTime(long msec)
{
    //struct timepsec timeout;
    ...
    case InterfaceCAN:
        {
            ...
            result = PMDDeviceOpenPeriphCAN( hPeriph, NULL, addressTX, addressRX, 0);
        }
        break;
#endif
    case InterfaceSerial:
        {
            ...
            result = PMDDeviceOpenPeriphSerial( hPeriph, NULL, (char *) serialportno, 57600, PMDSerialParityNone, PMDSerialStopBits1);
    ...
    case InterfaceTCP:
        {
            ...
            result = PMDDeviceOpenPeriphTCP( hPeriph, NULL, addr, portnum, 0 );
        }
        break;
    default: 
...
PMDresult ReadBuffer(PMDAxisHandle* phAxis, PMDuint16 bufferID, PMDint32* pbuffer, PMDuint32 dwords_to_read)
{
    ...
    //if (PMD_ERR_OK == PMDDeviceMemoryOpen(&hMemory, phDevice, PMDDataSize_32Bit, PMDMemoryType_DPRAM))
    {
