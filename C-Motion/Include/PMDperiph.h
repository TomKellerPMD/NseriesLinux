...
#define PMD_INVALID_HANDLE      (0)
#define PMD_CONNECTED_HANDLE    (1)
...
PMDCFunc PMDDeviceOpenPeriphSerial      (PMDPeriphHandle* hPeriph, PMDDeviceHandle *hDevice, char* port, PMDparam baud, PMDSerialParity parity, PMDSerialStopBits stopbits);
