...
typedef enum {
        ...
        PMDSerialBaud460800                                     = 7,
         // the following are supported by N-Series ION only
        PMDSerialBaud921600                                     = 8,
        PMDSerialBaud1000000                                    = 9,
        PMDSerialBaud2000000                                    = 10,
        PMDSerialBaud2500000                                    = 11,
        PMDSerialBaud3333333                                    = 12,
        PMDSerialBaud5000000                                    = 13,
        PMDSerialBaud10000000                                   = 14
} PMDSerialBaud;
...
// Using a CANFD baud will enable extended data length mode
#define PMDCANFDBaud1000_5000                                   ((int)(PMDCANFDDataBaud5000000 << 4) | (int)PMDCANBaud1000000)
#define PMDCANFDBaud1000_4000                                   ((int)(PMDCANFDDataBaud4000000 << 4) | (int)PMDCANBaud1000000)
#define PMDCANFDBaud1000_2000                                   ((int)(PMDCANFDDataBaud2000000 << 4) | (int)PMDCANBaud1000000)
#define PMDCANFDBaud1000_1000                                   ((int)(PMDCANFDDataBaud1000000 << 4) | (int)PMDCANBaud1000000)
#define PMDCANFDBaud500_1000                                    ((int)(PMDCANFDDataBaud1000000 << 4) | (int)PMDCANBaud500000 )

typedef enum {
        PMDSPIModeRisingEdge         = 0, // SPI mode 1  (CPOL=0, CPHA=1)  Data sampled on subsequent falling edge of the clock, clock idles low
        PMDSPIModeRisingEdgeDelay    = 1, // SPI mode 0  (CPOL=0, CPHA=0)  Data sampled on rising edge of the clock, clock idles low
        PMDSPIModeFallingEdge        = 2, // SPI mode 3  (CPOL=1, CPHA=1)  Data sampled subsequent falling edge of the clock, clock idles high
        PMDSPIModeFallingEdgeDelay   = 3  // SPI mode 2  (CPOL=1, CPHA=0)  Data sampled on rising edge of the clock, clock idles high
} PMDSPIMode;
